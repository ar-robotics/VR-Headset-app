...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class XRPokeFollowAffordance : MonoBehaviour
    {
        ...
        public event Action<bool> OnEmergency;
        void OnPokeStateDataUpdated(PokeStateData data)
        {
            ...
            if (applyFollow)
            {
                ...
                if (targetPosition.y < 0.02)
                {
                    Debug.Log($"EMERGENCY_BUT: {targetPosition.y}");
                    Debug.Log($"EMERGENCY_BUTVAL: {true}");
            ...
            else if (m_ReturnToInitialPosition)
            {
                ...
                Debug.Log($"EMERGENCY_BUT: {m_InitialPosition.y}");
                Debug.Log($"EMERGENCY_BUTVAL: {false}");
            }
        }
